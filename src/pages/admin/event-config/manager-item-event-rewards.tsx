...
import ItemEventRewardsTable from '@/pages/admin/event-config/component/item-event-rewards-table';

export default function ManagerItemEventRewards() {
  return (
    <AdminLayout>
      <motion.div
        className="ml-64"
      ...
      >
        <div className="flex w-full flex-row items-center  justify-center bg-[#3b5998]">
          <span className="text-5xl font-bold text-yellow">
            Quản lý vật phẩm sự kiện nạp tiêu xu{' '}
          </span>
        </div>
        <div className="flex w-full items-center justify-center ">
          <span className="flex items-center divide-y px-8 py-4 text-center text-2xl text-black">
            Gồm các chức năng : Xoá vật phẩm sự kiện NẠP - TIÊU xu
          </span>
        </div>
        <motion.div
          initial="hidden"
